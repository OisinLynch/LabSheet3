...
namespace LabSheet3Q5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Calling the static properties
            Console.WriteLine("Total money in all cash registers: {0}", CashRegister.totalMoneyAllCrs);
            Console.WriteLine("Total items in all cash registers: {0}", CashRegister.totalItemsAllCrs);
        }
    }
}
